---
title: "May 24 2023"
description: In-cycle sampling on Wednesday, May 24 2023
image: "230524_files/figure-html/in-cycle plot-1.png"
date: 2023-05-24
...
This week I only used glucose as the COD source
...
Taking a closer look at the nutrient dynamics:
...
```{r save rates to csv}
rates_df <- tibble(rate = c("ana_phos", "anx_phos", "aer_phos", "anx_denit", "ana_glu"),
                   value = c(ana_phos_rate, anx_phos_rate, aer_phos_rate, anx_denit_rate, ana_glu_rate),
                   )
