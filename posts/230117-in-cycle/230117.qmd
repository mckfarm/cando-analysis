...
description: In-cycle sampling on Monday, January 17 2023
image: "230117_files/figure-html/in-cycle plot-1.png"
date: 2023-01-17
...
* Sustained P uptake in anoxic phase
...
anx_denit_rate <- get_max_rate_custom_range(df, "anx", "nitrite", 2, 5, solids)
...
aer_phos_rate <- get_max_rate_custom_range(df, "aer", "phosphate", 3, 4, solids)
